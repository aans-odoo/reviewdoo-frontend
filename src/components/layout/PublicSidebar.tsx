...
/**
 * Sidebar that works for both authenticated and anonymous users.
 * Anonymous users see a reduced set of nav items and a "Log In" button
 * instead of the user profile section.
 */
export function PublicSidebar() {
  const { isAdmin, isAuthenticated, user, logout, updateProfile } = useAuth();
